...
# Everything is commented out by default.  Had some problems over Tor that I suspect is due to 
# latency where the message would be flooded over and over into the channel, but have not investigated
# or confirmed this suspicion.
MYPID=$$
